          ...
          <div v-if="rowData.yaml">
            ...
            <div class="border border-gray-200 dark:border-gray-600 rounded-lg">
              <div class="bg-gray-50 dark:bg-gray-700 p-4">
                <pre class="text-sm max-h-80 overflow-y-auto text-gray-800 dark:text-gray-200 whitespace-pre-wrap"><code>{{ rowData.yaml || 'No YAML configuration available' }}</code></pre>
              </div>
            </div>
          </div>
